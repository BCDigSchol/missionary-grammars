...
the Nicholas M. Williams Ethnological Collection of the the John J. Burns Library at
...
longer project, and further to model XML rendering of older linguistic documentation. All of the TEI files are housed in the TAPAS <a href="http://www.tapasproject.org/missionary-linguistics" target="_blank">repository</a>, but are also directly accessible on this site.
