...
ReactDOM.render(React.createElement(SearchPage, { source: "/texts/search" }), document.getElementById('container'));
var SearchPage = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(SearchPane, { fields: this.state.fields, handleUpdate: this.handleUpdate }),
...
var SearchPane = React.createClass({
    ...
    render: function () {
        ...
        var fields = this.props.fields.map(function (field) {
            return React.createElement(SelectList, { key: field.name, handleUpdate: this_pane.props.handleUpdate, field: field });
        });
        return React.createElement(
            'div',
...
var SelectList = React.createClass({
    ...
    render: function () {
        ...
        var options = this.props.field.options.map(function (option) {
            ...
            return React.createElement('option', { key: key, label: option.label, value: option.value });
        });
        return React.createElement(
            'div',
            ...
            React.createElement(
                'select',
                { name: this.props.field.name, onChange: this.handleChange },
                React.createElement(
                    'option',
                    { value: '' },
                    'Any'
...
var SearchResults = React.createClass({
    ...
    render: function () {
        var results = this.props.results.map(function (result) {
            return React.createElement(SearchResult, { key: result.id, result: result });
        });
        return React.createElement(
            'div',
